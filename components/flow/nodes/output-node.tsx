    ...
    <NodeFrame
      ...
      overlay={
        nodeOutputLines !== null && (
          <div
            data-block-overlay="output"
            className="nodrag nowheel absolute -top-2 left-full ml-4 z-40 flex w-56 flex-col gap-1 rounded-xl border border-cyan-500/40 bg-card p-2.5 text-xs font-mono shadow-xl backdrop-blur"
          >
